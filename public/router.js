const VIEW_TITLES = {
  ...
  'world-dungeon-salary': 'World Dungeon Salary — Capital Records',
  users: 'Users — Capital Records',
  'activity-log': 'Activity Log — Capital Records',
};
const VALID_VIEWS = ['members', 'queue', 'loot', 'loot-session', 'caves', 'cave-date', 'cave-session', 'cave-report', 'cave-loot-list', 'cave-salary', 'cave-schedule', 'items', 'bosses', 'world-dungeon', 'world-dungeon-salary', 'users', 'activity-log'];
