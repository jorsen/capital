...
function ensureSchema() {
  if (!schemaReady) {
    schemaReady = (async () => {
      ...
      // loot) — drop these columns for anyone who already has the table from
      // an earlier version of this feature.
...
module.exports = { sql, ensureSchema, getClasses, SLOTS, DEFAULT_ITEM_CATEGORIES };
